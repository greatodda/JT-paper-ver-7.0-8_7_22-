...
\begin{corollary}
Let $\lambda$ be a block $n$-staircase partition. Let $\lambda'$ be the corresponding conjugate partition. Then, 
\[
...
Of the three skew partitions below, only the first is a ribbon, since (ii) contains a $2\times 2$ block (shaded), and (iii) is disconnected.
