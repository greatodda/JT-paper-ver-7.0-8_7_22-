...
\item the ``\emph{staircase case}'': $u_i = n-2i+2j+1$ for each $i,j = 1, 2, \ldots, n$;
...
weakly decreasing sequence of positive integers
$(\lambda_1, \lambda_2, \cdots ,\lambda_k)$, with
...
\begin{definition}[Jacobi--Trudi matrix]
