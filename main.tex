...
\bigskip\noindent\textbf{Keywords:} Jacobi--Trudi matrices, Schur functions, finite fields, determinants, Toeplitz matrices.

\bigskip\noindent\textbf{MSC classes (2020 Mathematics Subject Classification):} 05E05, 15B05, 11T06, 11C20.
...
Then $s_{\lambda/\mu}$ is the sum of monomials
\[
\mathbf{x}_T = \prod_{i=1}^{\infty} x_i^{\text{\# of $i$'s in }T}
\]
over all semistandard tableaux $T$ of shape $\lambda / \mu$.
