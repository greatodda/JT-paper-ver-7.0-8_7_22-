...
\begin{proof}
Consider the bottom element of $A_{j}$; this is an indeterminate
...
\begin{proof}
\textbf{(a)} When we pass from $M$ to $M^{\prime}$, each block of
...
So let us consider a multislant matrix $M$ that is square and nonempty and
has signature
