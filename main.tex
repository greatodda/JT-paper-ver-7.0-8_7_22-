...
ring of symmetric functions (see \S \ref{sec.def} for a detailed definition and further exploration), then the determinant of
...
For example, if $\lambda$ is the partition in Figure 1, then the Schur polynomial $s_\lambda$ is given by
 \begin{align*}
s_{(6,5,4,3,2,1)} =
\det
\begin{pmatrix}
