...
Thus, an $N$-tuple $\tup{x_1, x_2, \ldots, x_N} \in \Fq^N$
satisfies
$s_{\lambda / \mu } \tup{x_1, x_2, \ldots, x_{N}} = a$ if
and only if
$(-1)^{\ell+1} x_N + g( x_1, x_2, \ldots,x_{N-1}) = a$.
Clearly, the latter equality has a unique solution for $x_N$
if $x_1, x_2, \ldots, x_{N-1}$ are given.

Hence, for any $\tup{x_1, x_2, \ldots, x_{N-1}} \in \Fq^{N-1}$, there is
exactly one value of $x_N \in \Fq$ that satisfies
$s_{\lambda / \mu } \tup{x_1, x_2, \ldots, x_{N}} = a$.
In other words, we have
\[
\left(  \text{\# of }\left(  x_{1},x_{2},\ldots,x_{N}\right)  \in\mathbb{F}_{q}^{N}
\ \mid\ (-1)^{n+1} x_N + g( x_1, x_2, \ldots,x_{N-1}) =a\right)
= q^{N-1}.
\]
...
&=\dfrac{\left(  \text{\# of }\left(  x_{1}%
,x_{2},\ldots,x_{N}\right)  \in\mathbb{F}_{q}^{N}\text{ such that } s_{\lambda / \mu } \left(
x_{1},x_{2},\ldots,x_{N}\right)  =a\right)  }{\left(  \text{\# of all }\left(
x_{1},x_{2},\ldots,x_{N}\right)  \in\mathbb{F}_{q}^{N}\right)  }\\
\\
